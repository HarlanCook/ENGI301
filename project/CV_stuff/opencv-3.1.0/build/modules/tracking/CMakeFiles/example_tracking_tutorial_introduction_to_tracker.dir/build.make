...
modules/tracking/CMakeFiles/example_tracking_tutorial_introduction_to_tracker.dir/samples/tutorial_introduction_to_tracker.cpp.o: /var/lib/cloud9/test/bbb_wireless/opencv_contrib-3.1.0/modules/tracking/samples/tutorial_introduction_to_tracker.cpp
...
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_tracking.so.3.1.0
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_video.so.3.1.0
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_datasets.so.3.1.0
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_face.so.3.1.0
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_objdetect.so.3.1.0
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_text.so.3.1.0
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_features2d.so.3.1.0
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_flann.so.3.1.0
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_ml.so.3.1.0
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_highgui.so.3.1.0
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_videoio.so.3.1.0
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_imgcodecs.so.3.1.0
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_imgproc.so.3.1.0
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_core.so.3.1.0
bin/example_tracking_tutorial_introduction_to_tracker: modules/tracking/CMakeFiles/example_tracking_tutorial_introduction_to_tracker.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/var/lib/cloud9/test/bbb_wireless/opencv-3.1.0/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/example_tracking_tutorial_introduction_to_tracker"
	cd /var/lib/cloud9/test/bbb_wireless/opencv-3.1.0/build/modules/tracking && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example_tracking_tutorial_introduction_to_tracker.dir/link.txt --verbose=$(VERBOSE)
...
modules/tracking/CMakeFiles/example_tracking_tutorial_introduction_to_tracker.dir/clean:
	cd /var/lib/cloud9/test/bbb_wireless/opencv-3.1.0/build/modules/tracking && $(CMAKE_COMMAND) -P CMakeFiles/example_tracking_tutorial_introduction_to_tracker.dir/cmake_clean.cmake
...
modules/tracking/CMakeFiles/example_tracking_tutorial_introduction_to_tracker.dir/depend:
	cd /var/lib/cloud9/test/bbb_wireless/opencv-3.1.0/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /var/lib/cloud9/test/bbb_wireless/opencv-3.1.0 /var/lib/cloud9/test/bbb_wireless/opencv_contrib-3.1.0/modules/tracking /var/lib/cloud9/test/bbb_wireless/opencv-3.1.0/build /var/lib/cloud9/test/bbb_wireless/opencv-3.1.0/build/modules/tracking /var/lib/cloud9/test/bbb_wireless/opencv-3.1.0/build/modules/tracking/CMakeFiles/example_tracking_tutorial_introduction_to_tracker.dir/DependInfo.cmake --color=$(COLOR)
