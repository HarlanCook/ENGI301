...
modules/structured_light/CMakeFiles/example_structured_light_pointcloud.dir/samples/pointcloud.cpp.o: /var/lib/cloud9/test/bbb_wireless/opencv_contrib-3.1.0/modules/structured_light/samples/pointcloud.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/var/lib/cloud9/test/bbb_wireless/opencv-3.1.0/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object modules/structured_light/CMakeFiles/example_structured_light_pointcloud.dir/samples/pointcloud.cpp.o"
	cd /var/lib/cloud9/test/bbb_wireless/opencv-3.1.0/build/modules/structured_light && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/example_structured_light_pointcloud.dir/samples/pointcloud.cpp.o -c /var/lib/cloud9/test/bbb_wireless/opencv_contrib-3.1.0/modules/structured_light/samples/pointcloud.cpp
...
bin/example_structured_light_pointcloud: lib/libopencv_structured_light.so.3.1.0
bin/example_structured_light_pointcloud: lib/libopencv_viz.so.3.1.0
bin/example_structured_light_pointcloud: lib/libopencv_rgbd.so.3.1.0
bin/example_structured_light_pointcloud: lib/libopencv_calib3d.so.3.1.0
bin/example_structured_light_pointcloud: lib/libopencv_features2d.so.3.1.0
bin/example_structured_light_pointcloud: lib/libopencv_flann.so.3.1.0
bin/example_structured_light_pointcloud: lib/libopencv_ml.so.3.1.0
bin/example_structured_light_pointcloud: lib/libopencv_highgui.so.3.1.0
bin/example_structured_light_pointcloud: lib/libopencv_videoio.so.3.1.0
bin/example_structured_light_pointcloud: lib/libopencv_imgcodecs.so.3.1.0
bin/example_structured_light_pointcloud: lib/libopencv_imgproc.so.3.1.0
bin/example_structured_light_pointcloud: lib/libopencv_core.so.3.1.0
bin/example_structured_light_pointcloud: modules/structured_light/CMakeFiles/example_structured_light_pointcloud.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/var/lib/cloud9/test/bbb_wireless/opencv-3.1.0/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/example_structured_light_pointcloud"
	cd /var/lib/cloud9/test/bbb_wireless/opencv-3.1.0/build/modules/structured_light && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example_structured_light_pointcloud.dir/link.txt --verbose=$(VERBOSE)
...
modules/structured_light/CMakeFiles/example_structured_light_pointcloud.dir/clean:
	cd /var/lib/cloud9/test/bbb_wireless/opencv-3.1.0/build/modules/structured_light && $(CMAKE_COMMAND) -P CMakeFiles/example_structured_light_pointcloud.dir/cmake_clean.cmake
